  ...
  return (
    <div className="w-full sticky top-0 z-50">
      <div className="bg-gray-800 text-white text-center py-2 flex gap-2 justify-end pe-3">
        <ContentfulLink link={topHeaderBar.fields.contactEmail!} />

        <ContentfulLink link={topHeaderBar.fields.contactPhoneNumber!} />
        {topHeaderBar.fields.socialMediaLinks?.map((link) => (
